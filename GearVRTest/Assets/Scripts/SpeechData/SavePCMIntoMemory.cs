...
//SavePCMIntoMemory Editor Script
...
public static class SavePCMIntoMemory
{

    const int HEADER_SIZE = 44;

    public static bool Save(AudioClip clip, out byte[] bytes)
    {
    ...
    static MemoryStream CreateEmpty(MemoryStream mstream)
    {
