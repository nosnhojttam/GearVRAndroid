...
namespace NeuronDataReaderWraper
{
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct OptDataHeader
    {
        public ushort Token1;          // Package start token: 0xBBFF
        ...
        public UInt32 Reserved1;       // Reserved, only enable this package has 64bytes length
        public UInt32 Reserved2;       // Reserved, only enable this package has 64bytes length
        public ushort Token2;          // Package end token: 0xCCFF
    };
    ...
    /// <summary>
    /// OptDataReceive CALLBACK
    /// Remarks
    ///   The related information of the data stream can be obtained from optDataHeader.
    /// </summary>
    /// <param name="customObject">User defined object.</param>
    /// <param name="sockRef">Connector reference of TCP/IP client as identity.</param>
    /// <param name="bvhDataHeader">A OptDataHeader type pointer, to output the Opt data format information.</param>
    /// <param name="data">Float type array pointer, to output binary data.</param>
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void OptDataReceived(IntPtr customObject, IntPtr sockRef, IntPtr optDataHeader, IntPtr data);
    ...
    public delegate void  MatchedRigidBodyDataReceived(IntPtr customedObj, IntPtr sockRef, IntPtr byteData, int byteLen);
    ...
    public class NeuronDataReader
    {
        ...
        [DllImport(ReaderImportor, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern bool BRAcquireServerDispersion(string serverIp);

        [DllImport(ReaderImportor, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void BRRegisterMatchedDataCallback(IntPtr customedObj, MatchedRigidBodyDataReceived handle);
